...
class ResultsView(generic.DetailView):
    model = Question
    template_name = 'emp/results.html'
...
def vote(request, question_id):
    ...
    try:
        ...
        return render(request, 'emp/detail.html', { 'question': question,
    ...
    return HttpResponseRedirect(reverse('emp:results', args=(question.id,)))
